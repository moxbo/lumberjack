...
function runTests(): void {
  ...
  console.log(
    "Test 1: Window finished loading, but isLoading() returns true (race condition)",
  );
  ...
  console.log(
    "2. But isLoading() still returns true (e.g., background resource loading)",
  );
  console.log(
    "3. OLD version thinks window is not ready → logs buffered indefinitely",
  );
