...
function runTests() {
  ...
  // Test 2: Multiple entries
  {
    ...
    console.assert(
      getLogEntry(store, 1)?.message === "Second",
      "Test 2: Get entry by index",
    );
  ...
  // Test 3: Level index
  {
    ...
    console.assert(
      infoIndices.length === 2,
      "Test 3: Should find 2 INFO entries",
    );
    console.assert(
      infoIndices[0] === 0 && infoIndices[1] === 2,
      "Test 3: Correct indices",
    );
  ...
  // Test 4: Logger index
  {
    ...
    console.assert(
      aIndices.length === 2,
      "Test 4: Should find 2 logger A entries",
    );
  ...
  // Test 5: TraceId index
  {
    ...
    console.assert(
      traceIndices.length === 2,
      "Test 5: Should find 2 trace-123 entries",
    );
  ...
  // Test 6: Combined filtering
  {
    ...
    console.assert(
      filtered.length === 1,
      "Test 6: Combined filter should find 1 entry",
    );
  ...
  // Test 7: Timestamp sorting
  {
    ...
    console.assert(
      sortedDesc[0] === 0,
      "Test 7: First should be index 0 (desc)",
    );
    console.assert(
      sortedDesc[2] === 1,
      "Test 7: Last should be index 1 (desc)",
    );
  ...
  // Test 10: Clear store
  {
    ...
    console.assert(
      store.size === 0,
      "Test 10: Should have 0 entries after clear",
    );
    console.assert(
      store.levelIndex.size === 0,
      "Test 10: Indices should be cleared",
    );
