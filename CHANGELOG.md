...
### Added
- Add IndexedDB-backed log paging


### Changed
- Harden paged log storage


### Fixed
- **release**: Enhance sanity checks and tool availability messages in release script [skip-ci]
- Remove delayed filter application
...
### Fixed
- **parser**: Enhance logger field handling for improved query matching
